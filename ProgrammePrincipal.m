...
Xd = 15; Yd = 22;    %Position de la cible (phase de test de l'attraction vers la cible"
%%Xd = 20; Yd = 20;
%%
%%Postions des obstacles
PositionsObstacles = [];
%%
